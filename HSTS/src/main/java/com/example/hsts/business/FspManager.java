package com.example.hsts.business;
...
import com.example.hsts.tools.FspToken;
...
//    }
    ...
    public boolean init(Context context, String appId,
        ...
        instance = FspPreferenceManager.getInstance(context);
        boolean AppConfig = instance.getAppConfig();
//        String appId = "";
//        String appSecret = "";
//        String serverAddr = "";
//
...
//        }
//        appId = HttpConfigs.getAppId();
//        appSecret = HttpConfigs.getAppSecret();
//        serverAddr = HttpConfigs.getHstServerAddress();
        ...
        configure.recvVoiceVariant = instance.getIsRecvVoiceVariant();
        ...
        int init = m_fspEngine.init();
        Logger.d("init result = " + init);

        boolean result = init == FspEngine.ERR_OK;
    ...
    public boolean login(String userId, String customName) {
        ...
        boolean isForceLogin = instance.getIsForceLogin();
