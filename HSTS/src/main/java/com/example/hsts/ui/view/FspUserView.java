...
public class FspUserView extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        m_tvInfo = findViewById(R.id.fsp_user_tv_info);
        m_btnMore = findViewById(R.id.fsp_video_btn_more);
        m_ivMicState = findViewById(R.id.fsp_video_iv_mic_state);
        m_pbAudioEnergy = findViewById(R.id.fsp_user_pb_audio_energy);
        m_userNameLabel = findViewById(R.id.user_name_label);
        m_userNameText = findViewById(R.id.user_name_text);
