...
public class AlertTimerPickerWidget {
    /**
     * 时间选择回调
     */
...
//                        tvTime.setText(getTime(date));
    ...
    public static void alertBottomWheelOption(Context context, ArrayList<?> list, final OnWheelViewClick click) {
        ...
        TextView tv_confirm = (TextView) view.findViewById(com.bigkoo.pickerview.R.id.btnSubmit);
        ...
        view.findViewById(com.bigkoo.pickerview.R.id.btnCancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
